                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Mobile Repairing</a></li>
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Welcome To Dashboard </a></li>
                            </ol>
                        </div>
                    ...
                    <div class="card widget-box-three">
                        <div class="card-body">
                            ...
                            <div class="overflow-hidden">
                                ...
                                <h2 class="mb-0"><span data-plugin="counterup"></span> <i class="mdi mdi-arrow-up text-success font-24"></i></h2>
                                <p class="text-muted mt-2 m-0"><span class="font-weight-medium"></span></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card widget-box-three">
                        <div class="card-body">
                            ...
                            <div class="overflow-hidden">
                                ...
                                <h2 class="mb-0"><span data-plugin="counterup"></span> <i class="mdi mdi-arrow-down text-danger font-24"></i></h2>
                                <p class="text-muted mt-2 m-0"><span class="font-weight-medium"></span> </p>
                            </div>
                ...
                <div class="col-lg-6 col-xl-3">
                    <div class="card widget-box-three">
                        <div class="card-body">
                            ...
                            <div class="overflow-hidden">
                                <p class="text-uppercase font-weight-medium text-truncate mb-2"></p>
                                <h2 class="mb-0"><span data-plugin="counterup"></span> <i class="mdi mdi-arrow-down text-danger font-24"></i></h2>
                                <p class="text-muted mt-2 m-0"><span class="font-weight-medium"></span></p>
                            </div>
