            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li><a href="{{route('device')}}">Device / Brand</a></li>
                        <li><a href="{{route('series')}}">Device Series</a></li>
                        <li><a href="{{route('model')}}">Device Modal</a></li>
                        <li><a href="{{route('issuesimage')}}">Issue Images</a></li>
                        <li><a href="{{route('issues')}}">Modal Issues</a></li>
                        
                    </ul>
                </li>

                <li>
                    <a href="{{route('store')}}" class="waves-effect waves-light">
                ...
                <li>
                    <a href="{{route('services')}}" class="waves-effect waves-light">
                        <i class="mdi mdi-invert-colors"></i>
                        <span> Services </span>
                ...
                <li>
                    <a href="{{route('repair_service')}}" class="waves-effect waves-light">
                        <i class="mdi mdi-invert-colors"></i>
                ...
                <li>
                    <a href="{{route('sliders')}}" class="waves-effect waves-light">
                        <i class="mdi mdi-invert-colors"></i>
                        <span> Slider </span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{route('content')}}" class="waves-effect waves-light">
                        <i class="mdi mdi-invert-colors"></i>
                ...
                <li>
                    <a href="{{route('footer')}}" class="waves-effect waves-light">
                        <i class="mdi mdi-invert-colors"></i>
                ...
                <li>
                    <a href="{{route('issuepageimage')}}" class="waves-effect waves-light">
                        <i class="mdi mdi-invert-colors"></i>
                        <span> Issue Page Images </span>
                    </a>
                </li>
