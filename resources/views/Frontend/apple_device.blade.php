...
<div class="container">
	<div class="row">
		...
		<!--	<div class="about-box active center-block bg-blue wow zoomIn" data-wow-delay="500ms" onClick="getSeriesModals('{{$serie->id}}','{{$appleID}}')" style="background-color:#fff">-->
		<!--		<div class="about-main-icon pb-4">-->
		<!--			<img src="{{asset('frontend/image/Series')}}/{{$serie->image}}">-->
		<!--		</div>-->
