...
<div class="container">
	<div class="row">
		...
		<div class="col-md-2 col-sm-12">
            <div class="about-box active center-block bg-blue wow zoomIn" data-wow-delay="500ms" onClick="getSeriesModals('{{$serie->id}}','{{$huaweiID}}')">
