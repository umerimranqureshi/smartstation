<script>
    ...
    function initMap() {
        ...
        map.data.setStyle((feature) => {
            return {
                icon: {
                    url:'{{asset('')}}frontend/image/icon_${feature.getProperty('+category+')}.png',
                    scaledSize: new google.maps.Size(64, 64),
                },
            };
        });

        const apiKey = 'AIzaSyAUMoVX1-rpci7KMQ5P9ZZMIcIs7wM3FBI';
      ...
      <img style="float:left; width:200px; margin-top:30px" src="{{asset('')}}frontend/image/logo_${category}.png">
